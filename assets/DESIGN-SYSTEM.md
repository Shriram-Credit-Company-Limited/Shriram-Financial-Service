...
| Hero H1 | 32px | 500 | 1.12 | `#fff` | `letter-spacing:-0.64px`; highlight span `--gold-2` |
| Hero lead | 18px | 400 | 29.7px | `rgba(255,255,255,.74)` | `max-width:600px` |
...
`clamp(20px,5.4vw,24px)`, hero H1 `clamp(24px,6.4vw,32px)`, CTA H3 `clamp(24px,6.4vw,38px)`.
